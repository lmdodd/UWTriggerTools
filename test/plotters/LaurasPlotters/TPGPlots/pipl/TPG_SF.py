...
canvas
ntuple_10.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l10_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
ntuple_15.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l15_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
ntuple_20.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l20_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
ntuple_25.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l25_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
ntuple_30.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l30_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
ntuple_35.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l35_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
ntuple_40.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l40_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
ntuple_45.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l45_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
ntuple_50.Draw("genPt/(TPGH+cTPGe5x5):TPG5x5_tpgeta>>l50_1(56,0,56,100,0,7)","TPG5x5_tpgeta<100 && TPGH>3","BOX")
...
l15_1.SetTitle('GenPt/cTPG5x5 vs tpg Eta')
...
hproj15_1.GetYaxis().SetRangeUser(0,4)
...
legend1.AddEntry(hproj10_1, "Pi+ Pt=10 GeV")
legend1.AddEntry(hproj15_1, "Pi+ Pt=15 GeV")
legend1.AddEntry(hproj20_1, "Pi+ Pt=20 GeV")
legend1.AddEntry(hproj25_1, "Pi+ Pt=25 GeV")
legend1.AddEntry(hproj30_1, "Pi+ Pt=30 GeV")
legend1.AddEntry(hproj35_1, "Pi+ Pt=35 GeV")
legend1.AddEntry(hproj40_1, "Pi+ Pt=40 GeV")
legend1.AddEntry(hproj45_1, "Pi+ Pt=45 GeV")
legend1.AddEntry(hproj50_1, "Pi+ Pt=50 GeV")
legend1.Draw("same")
saveas=saveWhere+'SF_eta_h.png'
