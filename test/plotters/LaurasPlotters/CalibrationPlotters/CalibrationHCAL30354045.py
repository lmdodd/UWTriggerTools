...
legend1.AddEntry(profilel15_2, "PionPl Pt=30 GeV")
legend1.AddEntry(profilel20_2, "PionPl Pt=35 GeV")
legend1.AddEntry(profilel35_2, "PionPl Pt=40 GeV")
legend1.AddEntry(profilel50_2, "PionPl Pt=45 GeV")
legend1.Draw("same")
saveas=saveWhere+'SF_regionpt.png'
