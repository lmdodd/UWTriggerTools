...
canvas
ntuple_15.Draw("genPt:maxRegionPt_Eta>>l15_1","maxRegionPt>0","BOX")
ntuple_20.Draw("genPt:maxRegionPt_Eta>>l20_1","maxRegionPt>0","BOX")
ntuple_35.Draw("genPt:maxRegionPt_Eta>>l35_1","maxRegionPt>0","BOX")
ntuple_50.Draw("genPt:maxRegionPt_Eta>>l50_1","maxRegionPt>0","BOX")
...
hproj15_1.GetYaxis().SetRangeUser(0.6,1.3)
...
hproj15_1.Divide(hproj15_2)
hproj20_1.Divide(hproj20_2)
hproj35_1.Divide(hproj35_2)
hproj50_1.Divide(hproj50_2)
hproj15_1.Draw("")
hproj20_1.Draw("same")
hproj35_1.Draw("same")
hproj50_1.Draw("same")
legend1.Draw("same")
saveas=saveWhere+'SF_Divide_eta.png'
canvas.SaveAs(saveas)
