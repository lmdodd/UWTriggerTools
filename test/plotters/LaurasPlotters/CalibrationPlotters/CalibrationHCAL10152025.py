...
profilel15_2.GetYaxis().SetTitle("L1 TriggerPT")
...
legend1.AddEntry(profilel15_2, "PionPl Pt=10 GeV")
legend1.AddEntry(profilel20_2, "PionPl Pt=15 GeV")
legend1.AddEntry(profilel35_2, "PionPl Pt=20 GeV")
legend1.AddEntry(profilel50_2, "PionPl Pt=25 GeV")
legend1.Draw("same")
saveas=saveWhere+'SF_triggerpt.png'
