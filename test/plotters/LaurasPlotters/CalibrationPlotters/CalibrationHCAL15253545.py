...
legend1.AddEntry(profilel15_2, "PionPl Pt=15 GeV")
legend1.AddEntry(profilel20_2, "PionPl Pt=25 GeV")
legend1.AddEntry(profilel35_2, "PionPl Pt=35 GeV")
legend1.AddEntry(profilel50_2, "PionPl Pt=45 GeV")
legend1.Draw("same")
...
canvas
ntuple_15.Draw("maxRegionPt-genPt>>l15_9(80,-30,20)","maxRegionPt>0","BOX")
ntuple_20.Draw("maxRegionPt-genPt>>l20_9(80,-30,20)","maxRegionPt>0","BOX")
ntuple_35.Draw("maxRegionPt-genPt>>l35_9(80,-30,20)","maxRegionPt>0","BOX")
ntuple_50.Draw("maxRegionPt-genPt>>l50_9(80,-30,20)","maxRegionPt>0","BOX")
...
profilel15_7.GetXaxis().SetRangeUser(7,15)
