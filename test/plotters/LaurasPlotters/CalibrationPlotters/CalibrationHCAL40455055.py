...
profilel15_2.GetYaxis().SetRangeUser(0.6,1.1)
...
legend1.AddEntry(profilel15_2, "PionPl Pt=40 GeV")
legend1.AddEntry(profilel20_2, "PionPl Pt=45 GeV")
legend1.AddEntry(profilel35_2, "PionPl Pt=50 GeV")
legend1.AddEntry(profilel50_2, "PionPl Pt=55 GeV")
legend1.Draw("same")
...
hproj15_1.GetYaxis().SetRangeUser(0.7,1.9)
