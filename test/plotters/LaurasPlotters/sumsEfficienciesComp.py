...
def compare_efficiencies(oct_ntuple, uct_ntuple, variable='recoMET',
                         ...
                         legend_label='',
                         uct_legend = 'UCT2015 Calib',
                         l1_legend = 'UCT2015 No Calib',
                         filename=None,
                         binning = (40, 0, 400)
                        ):
...
ntuple_file_c = ROOT.TFile(infile_corr)


#ntuple_file = ROOT.TFile("/scratch/efriis/uct_jet_efficiency.root")
uct_sums_ntuple = ntuple_file_c.Get("uctSumsEfficiency/Ntuple")
l1_sums_ntuple = ntuple_file.Get("uctSumsEfficiency/Ntuple")
#################
